    ...
    public String shortestPath(Node start, Node end) {
        ...
        while (true) {
            ...
            if (currentNode == end) {
                ...
                System.out.println(" The time it will take is: " + shortestPath.get(end)/2 + " seconds");
                return path + "\n   ||     The path costs: " + shortestPath.get(end) + " " + "       ||   The time it will take is: " + shortestPath.get(end)/2 + " seconds";
            }
            currentNode.visit();
